        ...
        public void showResults()
        {
                ...
                while (fileIterator.hasNext())
                {
                        ...
                        while(classesIterator.hasNext())
                        {
                                ...
                                System.out.println("       - " + superName + "\u005cn");
                                /*
				 ...
				 */
					...
					System.out.println("   Sa portee: " + m.range.toString() +"\n");	
	   			 	*/
                                ...
                                // Question #4
                                System.out.println("Affichage du couplage entre classes relatif aux methodes\u005cn");
 ...
 */
  ...
  String temp = "";
    ...
    case PACKAGE:
      temp = PackageDeclaration();
      break;
    default:
      jj_la1[0] = jj_gen;
      ;
    }
                                   javaFile.set_Package(temp);mjfm.actClass.packageName = temp;
    label_1:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case IMPORT:
      ...
      temp = ImportDeclaration();
                                javaFile.add_Import(temp);mjfm.actClass.imports.add(temp);
    }
    label_2:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
 ...
 String strName = "";
    ...
    jj_consume_token(SEMICOLON);
    mjfm.actClass.imports.add(strName);{if (true) return strName;}
    throw new Error("Missing return statement in function");
  }
    ...
    while (true) {
      ...
      case ABSTRACT:
        jj_consume_token(ABSTRACT);
                range.Abstract = true; mjfm.actClass.range.isAbstract = true;
        break;
      case FINAL:
        jj_consume_token(FINAL);
              range.Final = true; mjfm.actClass.range.isFinal = true;
        break;
      case PUBLIC:
        jj_consume_token(PUBLIC);
               range.set_Range(Range.PUBLIC); mjfm.actClass.range.range = MyRange.PUBLIC;
        break;
      case STRICTFP:
...
// AJOUT D'UNE CLASSE
//=========================================================
  final public void UnmodifiedClassDeclaration(Range r) throws ParseException {
  DescriptionClass c = new DescriptionClass();
  c.range = r;
  Token tNom;
  String strExtends = "";
    jj_consume_token(CLASS);
    tNom = jj_consume_token(IDENTIFIER);
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case EXTENDS:
    ...
    while (true) {
      ...
      case STATIC:
        jj_consume_token(STATIC);
              range.Static = true; mjfm.actClass.range.isStatic = true;
        break;
      case ABSTRACT:
        jj_consume_token(ABSTRACT);
                 range.Abstract = true; mjfm.actClass.range.isAbstract = true;
      ...
      case PROTECTED:
        jj_consume_token(PROTECTED);
                  range.set_Range(Range.PROTECTED); mjfm.actClass.range.range = MyRange.PRIVATE;
        break;
      case PRIVATE:
        jj_consume_token(PRIVATE);
                range.set_Range(Range.PRIVATE); mjfm.actClass.range.range = MyRange.PROTECTED;
        break;
      case STRICTFP:
        jj_consume_token(STRICTFP);
        break;
...
//=========================================================
 ...
 String strName = "";
    ...
    while (true) {
      ...
      case PUBLIC:
        jj_consume_token(PUBLIC);
              range.set_Range(Range.PUBLIC); ma.range.range = MyRange.PUBLIC;
        break;
      case PROTECTED:
        jj_consume_token(PROTECTED);
                  range.set_Range(Range.PROTECTED); ma.range.range = MyRange.PROTECTED;
        break;
      case PRIVATE:
        jj_consume_token(PRIVATE);
                range.set_Range(Range.PRIVATE); ma.range.range = MyRange.PRIVATE;
        break;
      case STATIC:
        jj_consume_token(STATIC);
               range.Static = true; ma.range.isStatic = true;
        break;
      case FINAL:
        jj_consume_token(FINAL);
              range.Final = true; ma.range.isFinal = true;
        break;
      case TRANSIENT:
 ...
 String strResult = "";
    strResult = VariableDeclaratorId();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case ASSIGN:
  ...
  String strResult = "";
  Token tIdent;
    tIdent = jj_consume_token(IDENTIFIER);
                         strResult = tIdent.toString();
    label_12:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case LBRACKET:
 ...
 Range range = new Range();
    ...
    while (true) {
      ...
      case PUBLIC:
        jj_consume_token(PUBLIC);
              range.set_Range(Range.PUBLIC); mm.range.range = MyRange.PUBLIC;
        break;
      case PROTECTED:
        jj_consume_token(PROTECTED);
                  range.set_Range(Range.PROTECTED); mm.range.range = MyRange.PROTECTED;
        break;
      case PRIVATE:
        jj_consume_token(PRIVATE);
                range.set_Range(Range.PRIVATE); mm.range.range = MyRange.PRIVATE;
        break;
      case STATIC:
        jj_consume_token(STATIC);
               range.Static = true; mm.range.isStatic = true;
        break;
      case ABSTRACT:
        jj_consume_token(ABSTRACT);
                 range.Abstract = true; mm.range.isAbstract = true;
        break;
      case FINAL:
        jj_consume_token(FINAL);
              range.Final = true; mm.range.isFinal = true;
        break;
      case NATIVE:
        jj_consume_token(NATIVE);
        break;
    ...
    strResult = ResultType();
    m = MethodDeclarator(mm);
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case THROWS:
  ...
  final public Method MethodDeclarator(MyMethod mm) throws ParseException {
 Method m = new Method();
 Token tName;
    tName = jj_consume_token(IDENTIFIER);
                        m.set_Name(tName.toString()); mm.nom = tName.toString();
    FormalParameters(mm);
    label_15:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
  ...
  final public void FormalParameters(MyMethod mm) throws ParseException {
    jj_consume_token(LPAREN);
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case BOOLEAN:
    case BYTE:
  ...
  final public void FormalParameter(MyMethod mm) throws ParseException {
  ...
  final public void ConstructorDeclaration() throws ParseException {
    ...
    case PUBLIC:
      ...
      case PUBLIC:
        jj_consume_token(PUBLIC);
              mm.range.range = MyRange.PUBLIC;
        break;
      case PROTECTED:
        jj_consume_token(PROTECTED);
                  mm.range.range = MyRange.PROTECTED;
        break;
      case PRIVATE:
        jj_consume_token(PRIVATE);
                mm.range.range = MyRange.PRIVATE;
        break;
      default:
        jj_la1[38] = jj_gen;
        jj_consume_token(-1);
 ...
 */
 ...
 Token tValeur, tTemp;
 String strValeur = "";
    tValeur = jj_consume_token(IDENTIFIER);
   strValeur = tValeur.toString();
    ...
    while (true) {
      ...
      jj_consume_token(DOT);
      tTemp = jj_consume_token(IDENTIFIER);
                                           strValeur += "." + tTemp.toString();
    }
   {if (true) return strValeur;}
    throw new Error("Missing return statement in function");
  }

  final public void NameList(MyClass c) throws ParseException {
 String str = null;
    str = Name();
                c.interfaces.add(str);System.out.println("#"+str+"#");
    label_20:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case COMMA:
      ...
      jj_consume_token(COMMA);
      str = Name();
                      c.interfaces.add(str);
    }
  }

  final public void NameListThrows(ThrowAble ta) throws ParseException {
 String str = null;
    str = Name();
                 ta.addThrowException(str);
    label_21:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case COMMA:
 ...
 */
  ...
  Token token = null;
    ...
    {if (true) return token == null ? "" : "." + token.toString();}
    throw new Error("Missing return statement in function");
  }
...
// added by Andrea Gini
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x0,0x0,0x20102000,0x0,0x2000,0x20002000,0x20002000,0x8000000,0x0,0xa2196000,0x20002000,0x20002000,0xa2094000,0x20002000,0x20002000,0x2000,0x2000,0x20002000,0x20002000,0x8000000,0xa2196000,0xa2094000,0x20000000,0x20000000,0x0,0x0,0x0,0x92094000,0x92094000,0x0,0x20002000,0x20002000,0x0,0x0,0x0,0x0,0xa2094000,0x20000000,0x0,0x0,0x0,0xb359c000,0x92094000,0x0,0x82094000,0x0,0x82094000,0x82094000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x92094000,0x0,0x0,0x92094000,0x10000000,0x0,0x0,0x0,0x0,0x10000000,0x0,0x0,0x10000000,0x10000000,0x92094000,0x0,0x0,0x0,0x0,0x0,0x0,0x9349c000,0xb359c000,0x9359c000,0x20000000,0x0,0x0,0x0,0x92094000,0x820000,0xb359c000,0x820000,0x4000000,0xb2094000,0x92094000,0x92094000,0x92094000,0x0,0x0,0x0,0x92094000,0x40000,0x40000000,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x1000,0x10,0x80008080,0x0,0x80008080,0x80008000,0x80008000,0x0,0x8,0xb226e3c0,0x8004e000,0x8004e000,0x2206e140,0x8024e200,0x8024e200,0x80008000,0x80008000,0x8004e000,0x8004e000,0x0,0xb226e3c0,0x2206e140,0x2204e000,0x2204e000,0x0,0x0,0x0,0x144a0d40,0x144a0d40,0x0,0x8024e200,0x8024e200,0x1000000,0x0,0x0,0x0,0x20140,0x0,0xe000,0xe000,0x1000000,0x5cfb0dc5,0x144a0d40,0x40000,0x20140,0x0,0x20140,0x10020140,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x20,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x144a0d40,0x0,0x0,0x144a0d40,0x4480c00,0x0,0x0,0x0,0x0,0x4480c00,0x0,0x0,0x4000800,0x4000000,0x144a0d40,0x0,0x0,0x0,0x400,0x0,0x0,0x5cfb0d45,0x5cfb0dc5,0x5cfb0dc5,0x0,0x0,0x0,0x0,0x144a0d40,0x0,0x5cfb0dc5,0x0,0x0,0x144a0d40,0x144a0d40,0x144a0d40,0x144a0d40,0x0,0x0,0x0,0x144a0d40,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x40000,0x100000,0x40000,0x0,0x0,0x0,0x0,0x44200,0x0,0x0,0x40200,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x40200,0x40200,0x0,0x0,0x80000,0x200000,0x10000,0x30053a2,0x30053a2,0x80000,0x0,0x0,0x0,0x44000,0x10000,0x80000,0x200,0x0,0x0,0x0,0x0,0x453a3,0x13a2,0x0,0x200,0x10000,0x0,0x200,0x80000,0x80000,0x200000,0x200000,0x4000000,0x0,0x0,0x0,0x0,0x0,0x90000000,0x90000000,0x0,0x60c00000,0x60c00000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x30013a2,0x3000000,0x3000000,0x13a2,0x30013a2,0x1000,0x0,0x0,0x1000,0x11a2,0x200,0x111000,0x1a2,0x0,0x30013a2,0x80000,0x4000,0x11000,0x0,0x10000,0x10000,0x453a3,0x453a3,0x453a3,0x0,0x80000,0x200000,0x200000,0x13a2,0x0,0x453a3,0x0,0x0,0x13a2,0x30013a2,0x13a2,0x13a2,0x80000,0x200,0x200,0x30013a2,0x0,0x0,0x8000000,};
   }
   private static void jj_la1_init_3() {
      jj_la1_3 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3c,0x3c,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xc,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3ff8000,0x3ff8000,0x0,0x1,0x2,0x200,0x400,0x100,0x0,0x0,0x0,0x0,0x0,0x7000,0x7000,0x30,0x30,0x8c0,0x8c0,0x30,0x3c,0x0,0x0,0x0,0x0,0x0,0xc,0xc,0x0,0x0,0x0,0x0,0x0,0x0,0x3c,0x0,0x0,0x0,0x0,0x0,0x0,0xc,0xc,0xc,0x0,0x0,0x3ff800c,0x3ff800c,0xc,0x0,0xc,0x0,0x0,0xc,0x3c,0xc,0xc,0x0,0x0,0x0,0x3c,0x0,0x0,0x0,};
   }
