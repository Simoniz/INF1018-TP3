...
public class AttributeList
   ...
   *
   * @param attributeName String : Le nom de l'attribut � rechercher.
   * @return Attribute : L'attribut trouv�. Null si non trouv�.
   */
  ...
  /**
   * Indique si deux listes d'attibuts sont �gales
   *
   ...
   * que la liste poss�de selon un range(public, private, protected).
   *
